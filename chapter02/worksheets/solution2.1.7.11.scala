...
// scala> cartesian(Set("a", "b"), Set(10, 20))
// res9: Set[(String, Int)] = Set((a,10), (a,20), (b,10), (b,20))

val result_b   =  cartesian(Set("a", "b"), Set(10, 20))
val expected_b: Set[(String, Int)] =  Set(("a",10), ("a",20), ("b",10), ("b",20))
